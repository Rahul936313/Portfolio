...
export function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 rounded-full bg-[var(--neon-blue)] opacity-20 blur-3xl animate-blob -z-10" />
      <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-[var(--neon-purple)] opacity-20 blur-3xl animate-blob -z-10" style={{ animationDelay: "4s" }} />
      <div className="absolute top-1/2 left-1/3 w-80 h-80 rounded-full bg-[var(--neon-pink)] opacity-10 blur-3xl animate-blob -z-10" style={{ animationDelay: "8s" }} />

      <div className="max-w-6xl w-full mx-auto px-6 grid md:grid-cols-[1.2fr_1fr] gap-10 items-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight mb-4">
            <span className="block text-muted-foreground text-2xl md:text-3xl font-mono mb-2">$ whoami</span>
            Rahul <span className="text-gradient">Singh</span>
          </h1>
          <div className="text-xl md:text-2xl font-mono text-muted-foreground mb-6 h-8">
          ...
          <div className="flex flex-wrap gap-3">
            <a href="#projects" className="group inline-flex items-center gap-2 bg-gradient-primary px-6 py-3 rounded-xl font-medium glow hover:scale-105 transition-transform">
              View Projects <ArrowRight size={16} className="group-hover:translate-x-1 transition" />
            </a>
            <a href="/resume.pdf" download className="inline-flex items-center gap-2 glass px-6 py-3 rounded-xl font-medium hover:border-[var(--neon-cyan)] transition">
              <Download size={16} /> Resume
            </a>
            <a href="#contact" className="inline-flex items-center gap-2 glass px-6 py-3 rounded-xl font-medium hover:border-[var(--neon-purple)] transition">
        ...
        >
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full p-1 bg-gradient-neon animate-float">
