  ...
  return (
    <Section id="education" eyebrow="education" title={<>Academic <span className="text-gradient">journey</span></>}>
      <motion.div
        ...
        className="neon-border rounded-3xl p-6 sm:p-8 md:p-10 relative overflow-hidden group"
      >
        ...
        <div className="relative grid grid-cols-[auto_1fr] md:grid-cols-[auto_1fr_auto] gap-4 sm:gap-6 items-center">
          <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-primary flex items-center justify-center glow">
